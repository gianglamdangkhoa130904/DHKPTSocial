...
const EditStoreModal = ({ isOpen, onClose, onSubmit, initialData }) => {
  ...
  // Cập nhật formData và selectedManagers khi initialData thay đổi
  useEffect(() => {
    setFormData(initialData);
    if (initialData.manager) {
      setSelectedManagers(initialData.manager);
    }
  }, [initialData]);
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-lg mx-4 shadow-2xl flex flex-col" style={{ maxHeight: '90vh' }}>
        ...
        <div className="flex justify-between items-center mb-4 pb-4 border-b-2 border-[#008500]/20">
          <div className="flex items-center gap-x-3">
            ...
            />
            {/* Tiêu đề */}
            <h3 className="text-xl font-bold text-[#008500]">Chỉnh sửa cửa hàng</h3>
          </div>
          {/* Nút đóng */}
          <button 
            onClick={onClose}
